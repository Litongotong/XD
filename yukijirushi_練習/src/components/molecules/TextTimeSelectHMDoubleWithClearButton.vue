...
import ButtonExtend from '../atoms/ButtonExtend.vue'
...
function handleClick() {
  selectedStartHourValue.value = '0'
  selectedStartMinuteValue.value = '0'
  selectedEndHourValue.value = '0'
  selectedEndMinuteValue.value = '0'
