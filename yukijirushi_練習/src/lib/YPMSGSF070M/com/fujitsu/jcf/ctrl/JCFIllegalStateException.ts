...
namespace lib.com.fujitsu.jcf.ctrl {
    export class JCFIllegalStateException extends lib.com.fujitsu.jcf.ctrl.JCFException {
        ...
        static __com_fujitsu_jcf_ctrl_JCFIllegalStateException_CLASS_NAME: string = "JCFIllegalStateException";
    }
    JCFIllegalStateException["__class"] = "lib.com.fujitsu.jcf.ctrl.JCFIllegalStateException";
