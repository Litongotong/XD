...
export default class YBMKKSF610SLogic extends SMSCjfLogicBase {
  ...
  findSoshiki(event: JCFEvent, context: JCFContext, returnInfo: JCFReturnInfo) {
    ...
    try {
      ...
      // 共有領域リセット
      this.removeUserDataWithObject(context, YBMKKSF610SLogic.SEARCH_RESULTS_KEY)
      this.removeUserDataWithObject(context, YBMKKSF610SLogic.SEARCH_INDEX_KEY)
      this.removeUserDataWithObject(context, YBMKKSF610SLogic.SEARCH_NM_SOSHIKI_RYAKU_KEY)
  ...
  nextSoshiki(event: JCFEvent, context: JCFContext, returnInfo: JCFReturnInfo) {
    ...
    if (nmValue.trim().equals('')) {
      ...
      // 念のため共有領域リセット
      this.removeUserDataWithObject(context, YBMKKSF610SLogic.SEARCH_RESULTS_KEY as any)
      this.removeUserDataWithObject(context, YBMKKSF610SLogic.SEARCH_INDEX_KEY as any)
  ...
  closeYbmSearch(
    ...
    super.removeUserDataWithUsecase(context, YBMKKSF610SLogic.USECASE)
