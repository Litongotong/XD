...
namespace lib.com.megsnow.yem.tss.cjf {
    /**
     ...
     */
    export abstract class YEMTSSF000LogicBase extends com.fujitsu.sms.sol.sys.cjf.SMSCjfLogicBase implements lib.com.megsnow.yem.tss.cjf.YEMTSSF000ItemDefines, lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines {
        /**
        ...
        public crvtBooleanToZeroOneStr(chkState: boolean): string {
            return (chkState === true) ? lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_ONE : lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_ZERO;
        }
        ...
        public chkStateToZeroOne(chkState: string): string {
            return (chkState === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_TRUE) ? lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_ONE : lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_ZERO;
        }

        public nullToBlank(value: string): string {
            return (value == null || (value === (" "))) ? lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_BLANK : value;
        }

        public blankToZeroStr(value: string): string {
            return (value.length === 0) ? lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_ZERO : value;
        }
        ...
        public initSprdCellPosition(spreadData: com.fujitsu.sms.sol.sys.cjf.SMSJCFSpreadData) {
            spreadData.setPosition$int$java_lang_String(lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.NUM_MINUS_ONE, lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_BLANK);
        }
        ...
        public addSlashYYMM(dateStr: string): string {
            if (dateStr == null || ((dateStr.trim()) === ("")))return lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_BLANK;
        ...
        public chgMaxDateToBlank(dateStr: string): string {
            if (dateStr === lib.com.megsnow.yem.tss.cjf.YEMTSSF000ItemDefines.DT_TEKIYOSHURYO_MAX){
                return lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_BLANK;
            }
            return dateStr;
        }
        ...
        public setSprdComboboxFromMessage$com_fujitsu_sms_sol_sys_cjf_SMSJCFSpreadData$java_util_HashMap_A$int$boolean(spreadData: com.fujitsu.sms.sol.sys.cjf.SMSJCFSpreadData, comboList: any[], columIndex: number, addBlankRow: boolean) {
            if (spreadData == null || comboList == null){
                return;
            }
            const cellElement: com.fujitsu.jcf.gui.JCFSelectableElement[] = this.convertToSelectableElements$java_util_HashMap_A$boolean(comboList, addBlankRow);
            spreadData.setColumnInformationSelectableElements(columIndex, cellElement);
        }

        public setSprdComboboxFromMessage$com_fujitsu_sms_sol_sys_cjf_SMSJCFSpreadData$java_util_HashMap_A$int$java_lang_String$java_lang_String$boolean(spreadData: com.fujitsu.sms.sol.sys.cjf.SMSJCFSpreadData, comboList: any[], columIndex: number, stKey: string, valueKey: string, addBlankRow: boolean) {
            if (spreadData == null || comboList == null){
                return;
            }
            const cellElement: com.fujitsu.jcf.gui.JCFSelectableElement[] = this.convertToSelectableElements$java_util_HashMap_A$java_lang_String$java_lang_String$boolean(comboList, stKey, valueKey, addBlankRow);
            spreadData.setColumnInformationSelectableElements(columIndex, cellElement);
        }
         ...
         * @throws Exception
         */
        public setSprdComboboxFromMessage(spreadData?: any, comboList?: any, columIndex?: any, stKey?: any, valueKey?: any, addBlankRow?: any) {
            if (((spreadData != null && spreadData instanceof <any>com.fujitsu.sms.sol.sys.cjf.SMSJCFSpreadData) || spreadData === null) && ((comboList != null && comboList instanceof <any>Array && (comboList.length == 0 || comboList[0] == null ||(comboList[0] != null))) || comboList === null) && ((typeof columIndex === 'number') || columIndex === null) && ((typeof stKey === 'string') || stKey === null) && ((typeof valueKey === 'string') || valueKey === null) && ((typeof addBlankRow === 'boolean') || addBlankRow === null)) {
                return <any>this.setSprdComboboxFromMessage$com_fujitsu_sms_sol_sys_cjf_SMSJCFSpreadData$java_util_HashMap_A$int$java_lang_String$java_lang_String$boolean(spreadData, comboList, columIndex, stKey, valueKey, addBlankRow);
            } else if (((spreadData != null && spreadData instanceof <any>com.fujitsu.sms.sol.sys.cjf.SMSJCFSpreadData) || spreadData === null) && ((comboList != null && comboList instanceof <any>Array && (comboList.length == 0 || comboList[0] == null ||(comboList[0] != null))) || comboList === null) && ((typeof columIndex === 'number') || columIndex === null) && ((typeof stKey === 'boolean') || stKey === null) && valueKey === undefined && addBlankRow === undefined) {
                return <any>this.setSprdComboboxFromMessage$com_fujitsu_sms_sol_sys_cjf_SMSJCFSpreadData$java_util_HashMap_A$int$boolean(spreadData, comboList, columIndex, stKey);
        ...
        public convertToSelectableElements$java_util_HashMap_A$boolean(elementMapList: any[], addBlankRow: boolean): com.fujitsu.jcf.gui.JCFSelectableElement[] {
        ...
        public convertToSelectableElements$java_util_HashMap_A$java_lang_String$java_lang_String$boolean(elementMapList: any[], stKey: string, valueKey: string, addBlankRow: boolean): com.fujitsu.jcf.gui.JCFSelectableElement[] {
            let comboElements: com.fujitsu.jcf.gui.JCFSelectableElement[] = null;
            if (addBlankRow){
                comboElements = (s => { let a=[]; while(s-->0) a.push(null); return a; })(elementMapList.length + 1);
                comboElements[0] = new com.fujitsu.jcf.gui.JCFSelectableElement("", "", false);
                for(let row: number = 1; row < comboElements.length; row++) {{
                    const elementMap: any = <any>elementMapList[row - 1];
                    const comboKey: string = <string>/* get */((m,k) => { if(m.entries==null) m.entries=[]; for(let i=0;i<m.entries.length;i++) if(m.entries[i].key==null && k==null || m.entries[i].key.equals!=null && m.entries[i].key.equals(k) || m.entries[i].key===k) { return m.entries[i].value; } return null; })(<any>elementMap, stKey);
                    const comboValue: string = <string>/* get */((m,k) => { if(m.entries==null) m.entries=[]; for(let i=0;i<m.entries.length;i++) if(m.entries[i].key==null && k==null || m.entries[i].key.equals!=null && m.entries[i].key.equals(k) || m.entries[i].key===k) { return m.entries[i].value; } return null; })(<any>elementMap, valueKey);
                    comboElements[row] = new com.fujitsu.jcf.gui.JCFSelectableElement(comboValue, comboKey, false);
                };}
            } else {
                comboElements = (s => { let a=[]; while(s-->0) a.push(null); return a; })(elementMapList.length);
        ...
        /**
         * 繝｡繝�繧ｻ繝ｼ繧ｸ縺ｮ隕∫ｴ�繧偵さ繝ｳ繝懊�懊ャ繧ｯ繧ｹ繝�繝ｼ繧ｿ縺ｫ螟画鋤縺吶ｋ<br>
         * 
         * @param {java.util.HashMap[]} elementMapList 繝｡繝�繧ｻ繝ｼ繧ｸ繝ｬ繧ｳ繝ｼ繝峨Μ繧ｹ繝�<br>
         * @param {string} stKey HashMap縺九ｉ險ｭ螳壹☆繧句�､�ｼ亥玄蛻��ｼ峨ｒ蜿門ｾ励☆繧九く繝ｼ
         * @param {string} valueKey HashMap縺九ｉ險ｭ螳壹☆繧句�､�ｼ亥錐遘ｰ�ｼ峨ｒ蜿門ｾ励☆繧九く繝ｼ
         * @param {boolean} addBlankRow 遨ｺ逋ｽ陦後ｒ蜷ｫ繧√ｋ縺九←縺�縺具ｼ�true:蜷ｫ繧√ｋ�ｼ�<br>
         * @return {com.fujitsu.jcf.gui.JCFSelectableElement[]} JCFSelectableElement
         */
        public convertToSelectableElements(elementMapList?: any, stKey?: any, valueKey?: any, addBlankRow?: any): com.fujitsu.jcf.gui.JCFSelectableElement[] {
            if (((elementMapList != null && elementMapList instanceof <any>Array && (elementMapList.length == 0 || elementMapList[0] == null ||(elementMapList[0] != null))) || elementMapList === null) && ((typeof stKey === 'string') || stKey === null) && ((typeof valueKey === 'string') || valueKey === null) && ((typeof addBlankRow === 'boolean') || addBlankRow === null)) {
                return <any>this.convertToSelectableElements$java_util_HashMap_A$java_lang_String$java_lang_String$boolean(elementMapList, stKey, valueKey, addBlankRow);
            } else if (((elementMapList != null && elementMapList instanceof <any>Array && (elementMapList.length == 0 || elementMapList[0] == null ||(elementMapList[0] != null))) || elementMapList === null) && ((typeof stKey === 'boolean') || stKey === null) && valueKey === undefined && addBlankRow === undefined) {
                return <any>this.convertToSelectableElements$java_util_HashMap_A$boolean(elementMapList, stKey);
            } else throw new Error('invalid overload');
        }

        public setCompErrColor$boolean$com_fujitsu_jcf_gui_JCFItemData(err_flg: boolean, itemdata: com.fujitsu.jcf.gui.JCFItemData) {
            if (err_flg === true){
                itemdata.setBackground(lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.CL_ERR_ON_COLOR_$LI$());
            } else {
                itemdata.setBackground(lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.CL_ERR_OFF_COLOR_$LI$());
            }
        }
        ...
        public setCompErrColor$boolean$com_fujitsu_jcf_gui_JCFItemData$int$int(err_flg: boolean, itemdata: com.fujitsu.jcf.gui.JCFItemData, column: number, row: number) {
            ...
            if (err_flg === true){
                spdData.setCellBackground(row, column, lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.CL_ERR_ON_COLOR_$LI$());
            } else {
                spdData.setCellBackground(row, column, lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.CL_ERR_OFF_COLOR_$LI$());
            }
        }
        ...
        public static taniKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String(suryotani2: string, qtIrisu: string, qtYoryo: string, tani: string): com.java.BigDecimal {
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor() Start");
            let ret: com.java.BigDecimal = null;
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():suryotani2[" + suryotani2 + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():irisu[" + qtIrisu + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():yoryo[" + qtYoryo + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():tani[" + tani + "]");
            if (suryotani2 == null || tani == null){
                return ret;
            }
            if (suryotani2 === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_SEIHIN_TANI_G){
                com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():\u8b28\uff70\u9a65\u4e1e\u8170\u83f4\u643e\uff7c\u5075\u2032G");
                if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = new com.java.BigDecimal("0.001");
                } else if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = new com.java.BigDecimal("1");
                } else if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                    ret = new com.java.BigDecimal("1000");
                } else {
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u870a\u5005\uff7d\u962a\u2032\u8373\u80b4\uff6d\uff63:" + tani);
                    return ret;
                }
            } else if (suryotani2 === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_SEIHIN_TANI_KO){
                com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():\u8b28\uff70\u9a65\u4e1e\u8170\u83f4\u643e\uff7c\u5075\u2032\ufffd\uff7d\uff7a");
                if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    const yoryo: com.java.BigDecimal = YEMTSSF000LogicBase.createBigDecimal(qtYoryo);
                    if (yoryo != null && yoryo.compareTo(new com.java.BigDecimal("0")) !== 0){
                        ret = new com.java.BigDecimal("1").divide$com_java_BigDecimal$int$java_lang_String(yoryo, 8, com.java.BigDecimal.ROUND_HALF_UP);
                    } else {
                        return ret;
                    }
                } else if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    const yoryo: com.java.BigDecimal = YEMTSSF000LogicBase.createBigDecimal(qtYoryo);
                    if (yoryo != null && yoryo.compareTo(new com.java.BigDecimal("0")) !== 0){
                        ret = new com.java.BigDecimal("1000").divide$com_java_BigDecimal$int$java_lang_String(yoryo, 8, com.java.BigDecimal.ROUND_HALF_UP);
                    } else {
                        return ret;
                    }
                } else if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                    const yoryo: com.java.BigDecimal = YEMTSSF000LogicBase.createBigDecimal(qtYoryo);
                    if (yoryo != null && yoryo.compareTo(new com.java.BigDecimal("0")) !== 0){
                        ret = new com.java.BigDecimal("1000000").divide$com_java_BigDecimal$int$java_lang_String(yoryo, 8, com.java.BigDecimal.ROUND_HALF_UP);
                    } else {
                        return ret;
                    }
                } else if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    ret = YEMTSSF000LogicBase.createBigDecimal(qtIrisu);
                } else if (tani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    ret = new com.java.BigDecimal("1");
                } else {
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u870a\u5005\uff7d\u962a\u2032\u8373\u80b4\uff6d\uff63:" + tani);
                    return ret;
                ...
                com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u8b28\uff70\u9a65\u4e1e\u8170\u83f4\u643e\uff7c\u5075\u2032\u8373\u80b4\uff6d\uff63:" + suryotani2);
                return ret;
            }
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():ret[" + ret + "]");
            return ret;
        }
        ...
        public isValidFilledDate$com_fujitsu_jcf_ctrl_JCFEvent$com_fujitsu_jcf_ctrl_JCFContext$com_fujitsu_jcf_ctrl_JCFReturnInfo$java_lang_String$java_lang_String$java_lang_String$boolean(event: com.fujitsu.jcf.ctrl.JCFEvent, context: com.fujitsu.jcf.ctrl.JCFContext, returnInfo: com.fujitsu.jcf.ctrl.JCFReturnInfo, frameID: string, itemID: string, itemName: string, required: boolean): boolean {
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase.isValidFilledDate Logic start : ");
            ...
            if (!required && (item.getValue() === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_DATE_ZERO)){
            ...
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase.isValidFilledDate Logic end : ");
        ...
        isValidFilledDateNengetsu(event: com.fujitsu.jcf.ctrl.JCFEvent, context: com.fujitsu.jcf.ctrl.JCFContext, returnInfo: com.fujitsu.jcf.ctrl.JCFReturnInfo, itemID: string, itemName: string, required: boolean): boolean {
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase.isValidFilledDateNengetsu Logic start : ");
            const current: com.fujitsu.jcf.ctrl.JCFScreenData = context.getCurrentScreenData();
            ...
            if (!required && (item.getValue() === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_DATE_ZERO)){
                ...
                if (!super.isValidFilledDate$java_lang_String(item.getValue())){
                    ...
                    returnInfo.cancelScreenTransition();
                    com.fujitsu.sms.sol.sys.cjf.logic.SMSHeaderFooterManager.showInformation$com_fujitsu_jcf_ctrl_JCFContext$java_lang_String$java_lang_String_A(context, com.fujitsu.sms.sol.sys.SMSMessageConst.SMSCMNMCA104, [itemName, lib.com.megsnow.yem.tss.cjf.YEMTSSF000ItemDefines.DT_NEN_MIN + "/01", lib.com.megsnow.yem.tss.cjf.YEMTSSF000ItemDefines.DT_NEN_MAX + "/12"]);
                    isValidFilledDate = false;
                } else {
                    item.setBackground(com.fujitsu.sms.sol.sys.SMSColor.DEFAULT);
                    isValidFilledDate = true;
            ...
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("String value              : [" + item.getValue() + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("boolean isValidFilledDate : [" + isValidFilledDate + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase.isValidFilledDateNengetsu Logic end : ");
            return isValidFilledDate;
        }
        ...
        public static taniKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$int$int(henkanMaeTani: string, qtIrisu: string, qtYoryo: string, henkanGoTani: string, val: string, scale: number, roundJoken: number): com.java.BigDecimal {
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor() Start");
            let ret: com.java.BigDecimal = new com.java.BigDecimal(0);
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():henkanMaeTani[" + henkanMaeTani + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():irisu[" + qtIrisu + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():yoryo[" + qtYoryo + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():henkanGoTani[" + henkanGoTani + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():val[" + val + "]");
            if (henkanMaeTani == null || henkanGoTani == null || val == null){
                return ret;
            }
            const decVal: com.java.BigDecimal = new com.java.BigDecimal(val);
            const decIrisu: com.java.BigDecimal = new com.java.BigDecimal(qtIrisu);
            const decYoryo: com.java.BigDecimal = new com.java.BigDecimal(qtYoryo);
            const decSen: com.java.BigDecimal = new com.java.BigDecimal("1000");
            const decMan: com.java.BigDecimal = new com.java.BigDecimal("1000000");
            const decZero: com.java.BigDecimal = new com.java.BigDecimal("0");
            let decTemp: com.java.BigDecimal;
            if (henkanMaeTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decIrisu,decZero))){
                        ret = decZero;
                    } else {
                        ret = decVal.divide$com_java_BigDecimal$int$int(decIrisu, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    ret = decVal;
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal.multiply(decYoryo);
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal.multiply(decYoryo);
                    ret = ret.divide$com_java_BigDecimal$int$int(decSen, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                    ret = decVal.multiply(decYoryo);
                    ret = ret.divide$com_java_BigDecimal$int$int(decMan, scale, roundJoken);
                } else {
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u879f\u753b\u92e4\u8815\u609f\u8170\u83f4\u962a\u2032\u8373\u80b4\uff6d\uff63:" + henkanGoTani);
                }
            } else if (henkanMaeTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    ret = decVal;
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    ret = decVal.multiply(decIrisu);
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal.multiply(decIrisu).multiply(decYoryo);
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal.multiply(decIrisu).multiply(decYoryo);
                    ret = ret.divide$com_java_BigDecimal$int$int(decSen, scale, roundJoken);
            ...
            } else if (henkanMaeTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("String decIrisu             : [" + decIrisu.toString() + "]");
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("String decYoryo             : [" + decYoryo.toString() + "]");
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decIrisu,decZero)) || /* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug(" \u8708\uff65\u7e67\u9811\u711a\u7e5d\uff7b\u87b3\uff79\u9a65\u4e0a\u305e\u7e5d\uff6d\u7e3a\uff6e\u7e3a\u6e98\uff41\u96aa\u80b2\uff6e\u52b1\uff20\u7e3a\uff6a\u7e3a\ufffd ");
                        ret = decZero;
                    } else {
                        com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug(" \u96aa\u80b2\uff6e\u52b1\u2606\u7e67\ufffd ");
                        decTemp = decYoryo.multiply(decIrisu);
                        ret = decVal.divide$com_java_BigDecimal$int$int(decTemp, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        ret = decVal.divide$com_java_BigDecimal$int$int(decYoryo, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal;
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal.divide$com_java_BigDecimal$int$int(decSen, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                    ret = decVal.divide$com_java_BigDecimal$int$int(decMan, scale, roundJoken);
                } else {
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u879f\u753b\u92e4\u8815\u609f\u8170\u83f4\u962a\u2032\u8373\u80b4\uff6d\uff63:" + henkanGoTani);
                }
            } else if (henkanMaeTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        decTemp = decYoryo.multiply(decIrisu);
                        ret = decVal.multiply(decSen).divide$com_java_BigDecimal$int$int(decTemp, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        ret = decVal.multiply(decSen).divide$com_java_BigDecimal$int$int(decYoryo, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal.multiply(decSen);
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal;
                    ret = ret.setScale(scale, roundJoken);
            ...
            } else if (henkanMaeTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        decTemp = decYoryo.multiply(decIrisu);
                        ret = decVal.multiply(decMan).divide$com_java_BigDecimal$int$int(decTemp, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        ret = decVal.multiply(decMan).divide$com_java_BigDecimal$int$int(decYoryo, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal.multiply(decMan);
                    ret = ret.setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal.multiply(decSen);
                    ret = ret.setScale(scale, roundJoken);
                ...
                com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u879f\u753b\u92e4\u8711\u698a\u8170\u83f4\u962a\u2032\u8373\u80b4\uff6d\uff63:" + henkanMaeTani);
                return ret;
            }
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():ret[" + ret + "]");
            return ret;
        ...
        /**
         * 讌ｭ蜍咏畑迚ｹ螢ｲ邊ｾ邂礼畑蜊倅ｽ肴鋤邂怜�ｦ逅�<br>
         * 蠑墓焚縺ｮ謨ｰ驥上�ｻ驥鷹｡阪ｒ謠帷ｮ励＠縺溽ｵ先棡繧定ｿ泌唆縺励∪縺吶��
         * 
         * @param {string} henkanMaeTani 螟画鋤蜑榊腰菴�
         * @param {string} qtIrisu       陬ｽ蜩√�ｮ蜈･謨ｰ
         * @param {string} qtYoryo	縲�   陬ｽ蜩√�ｮ螳ｹ驥�
         * @param {string} henkanGoTani  螟画鋤蠕悟腰菴�
         * @param {string} val           螟画鋤縺励◆縺�謨ｰ驥上�ｻ驥鷹｡�
         * @return {com.java.BigDecimal} 謠帷ｮ怜ｾ後�ｮ謨ｰ驥上�ｻ驥鷹｡阪��螟画鋤縺ｧ縺阪↑縺�蝣ｴ蜷医��0
         * 
         * @param {number} scale
         * @param {number} roundJoken
         */
        public static taniKanzanFactor(henkanMaeTani?: any, qtIrisu?: any, qtYoryo?: any, henkanGoTani?: any, val?: any, scale?: any, roundJoken?: any): com.java.BigDecimal {
            if (((typeof henkanMaeTani === 'string') || henkanMaeTani === null) && ((typeof qtIrisu === 'string') || qtIrisu === null) && ((typeof qtYoryo === 'string') || qtYoryo === null) && ((typeof henkanGoTani === 'string') || henkanGoTani === null) && ((typeof val === 'string') || val === null) && ((typeof scale === 'number') || scale === null) && ((typeof roundJoken === 'number') || roundJoken === null)) {
                return <any>lib.com.megsnow.yem.tss.cjf.YEMTSSF000LogicBase.taniKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$int$int(henkanMaeTani, qtIrisu, qtYoryo, henkanGoTani, val, scale, roundJoken);
            } else if (((typeof henkanMaeTani === 'string') || henkanMaeTani === null) && ((typeof qtIrisu === 'string') || qtIrisu === null) && ((typeof qtYoryo === 'string') || qtYoryo === null) && ((typeof henkanGoTani === 'string') || henkanGoTani === null) && val === undefined && scale === undefined && roundJoken === undefined) {
                return <any>lib.com.megsnow.yem.tss.cjf.YEMTSSF000LogicBase.taniKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String(henkanMaeTani, qtIrisu, qtYoryo, henkanGoTani);
            } else throw new Error('invalid overload');
        }

        public static tankaKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$int$int(henkanMaeTani: string, qtIrisu: string, qtYoryo: string, henkanGoTani: string, val: string, scale: number, roundJoken: number): com.java.BigDecimal {
            return YEMTSSF000LogicBase.tankaKanzan(henkanMaeTani, qtIrisu, qtYoryo, henkanGoTani, val, "1", scale, roundJoken);
        }

        public static tankaKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$int$int(henkanMaeTani: string, qtIrisu: string, qtYoryo: string, henkanGoTani: string, val: string, coefficient: string, scale: number, roundJoken: number): com.java.BigDecimal {
            return YEMTSSF000LogicBase.tankaKanzan(henkanMaeTani, qtIrisu, qtYoryo, henkanGoTani, val, coefficient, scale, roundJoken);
        }

        /**
         * 讌ｭ蜍咏畑迚ｹ螢ｲ邊ｾ邂礼畑 蜊倅ｾ｡謠帷ｮ怜�ｦ逅�<br>
         * 蠑墓焚縺ｮ謨ｰ驥上�ｻ驥鷹｡阪ｒ謠帷ｮ励＠縲∽ｿよ焚繧偵°縺代◆繧ゅ�ｮ繧定ｿ泌唆縺励∪縺吶��
         * �ｼ域鋤邂礼ｵ先棡 ﾃ� 菫よ焚縺ｧ邊ｾ邂鈴�鷹｡阪ｒ邂怜�ｺ縺励※縺�縺ｾ縺呻ｼ�
         * 
         * @param {string} henkanMaeTani 螟画鋤蜑榊腰菴�
         * @param {string} qtIrisu       陬ｽ蜩√�ｮ蜈･謨ｰ
         * @param {string} qtYoryo	縲�   陬ｽ蜩√�ｮ螳ｹ驥�
         * @param {string} henkanGoTani  螟画鋤蠕悟腰菴�
         * @param {string} val           螟画鋤縺励◆縺�謨ｰ驥上�ｻ驥鷹｡�
         * @param {string} coefficient   菫よ焚
         * @return {com.java.BigDecimal} 謠帷ｮ怜ｾ後�ｮ謨ｰ驥上�ｻ驥鷹｡阪��螟画鋤縺ｧ縺阪↑縺�蝣ｴ蜷医��0
         * 
         * @param {number} scale
         * @param {number} roundJoken
         */
        public static tankaKanzanFactor(henkanMaeTani?: any, qtIrisu?: any, qtYoryo?: any, henkanGoTani?: any, val?: any, coefficient?: any, scale?: any, roundJoken?: any): com.java.BigDecimal {
            if (((typeof henkanMaeTani === 'string') || henkanMaeTani === null) && ((typeof qtIrisu === 'string') || qtIrisu === null) && ((typeof qtYoryo === 'string') || qtYoryo === null) && ((typeof henkanGoTani === 'string') || henkanGoTani === null) && ((typeof val === 'string') || val === null) && ((typeof coefficient === 'string') || coefficient === null) && ((typeof scale === 'number') || scale === null) && ((typeof roundJoken === 'number') || roundJoken === null)) {
                return <any>lib.com.megsnow.yem.tss.cjf.YEMTSSF000LogicBase.tankaKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$int$int(henkanMaeTani, qtIrisu, qtYoryo, henkanGoTani, val, coefficient, scale, roundJoken);
            } else if (((typeof henkanMaeTani === 'string') || henkanMaeTani === null) && ((typeof qtIrisu === 'string') || qtIrisu === null) && ((typeof qtYoryo === 'string') || qtYoryo === null) && ((typeof henkanGoTani === 'string') || henkanGoTani === null) && ((typeof val === 'string') || val === null) && ((typeof coefficient === 'number') || coefficient === null) && ((typeof scale === 'number') || scale === null) && roundJoken === undefined) {
                return <any>lib.com.megsnow.yem.tss.cjf.YEMTSSF000LogicBase.tankaKanzanFactor$java_lang_String$java_lang_String$java_lang_String$java_lang_String$java_lang_String$int$int(henkanMaeTani, qtIrisu, qtYoryo, henkanGoTani, val, coefficient, scale);
            } else throw new Error('invalid overload');
        }

        /**
         * 讌ｭ蜍咏畑迚ｹ螢ｲ邊ｾ邂礼畑 蜊倅ｾ｡謠帷ｮ怜�ｦ逅�縺ｮ螳滓��<br>
         * 蠑墓焚縺ｮ謨ｰ驥上�ｻ驥鷹｡阪ｒ謠帷ｮ励＠縲∽ｿよ焚繧偵°縺代◆繧ゅ�ｮ繧定ｿ泌唆縺励∪縺吶��
         * �ｼ域鋤邂礼ｵ先棡 ﾃ� 菫よ焚縺ｧ邊ｾ邂鈴�鷹｡阪ｒ邂怜�ｺ縺励※縺�縺ｾ縺呻ｼ�
         * 
         * @param {string} henkanMaeTani 螟画鋤蜑榊腰菴�
         ...
         * @private
         */
        /*private*/ static tankaKanzan(henkanMaeTani: string, qtIrisu: string, qtYoryo: string, henkanGoTani: string, val: string, coefficient: string, scale: number, roundJoken: number): com.java.BigDecimal {
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor() Start");
            let ret: com.java.BigDecimal = new com.java.BigDecimal(0);
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():henkanMaeTani[" + henkanMaeTani + "]");
            com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("YEMTSSF000LogicBase#taniKanzanFactor():irisu[" + qtIrisu + "]");
            ...
            const decIrisu: com.java.BigDecimal = new com.java.BigDecimal(qtIrisu);
            const decYoryo: com.java.BigDecimal = new com.java.BigDecimal(qtYoryo);
            const decCoefficient: com.java.BigDecimal = new com.java.BigDecimal(coefficient);
            const decSen: com.java.BigDecimal = new com.java.BigDecimal("1000");
            const decMan: com.java.BigDecimal = new com.java.BigDecimal("1000000");
            const decZero: com.java.BigDecimal = new com.java.BigDecimal("0");
            let decTemp: com.java.BigDecimal;
            if (henkanMaeTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    ret = decVal.multiply(decIrisu);
                    ret = ret.multiply(decCoefficient).setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    ret = decVal;
                    ret = ret.multiply(decCoefficient).setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ...
                        ret = decVal.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decYoryo, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        ret = decVal.multiply(decCoefficient).multiply(decSen).divide$com_java_BigDecimal$int$int(decYoryo, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                    } else {
                        ret = decVal.multiply(decCoefficient).multiply(decMan).divide$com_java_BigDecimal$int$int(decYoryo, scale, roundJoken);
                    }
                } else {
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u879f\u753b\u92e4\u8815\u609f\u8170\u83f4\u962a\u2032\u8373\u80b4\uff6d\uff63:" + henkanGoTani);
                }
                ...
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    ...
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decIrisu,decZero))){
                        ...
                        ret = decVal.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decIrisu, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decIrisu,decZero)) || /* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                        ...
                        com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug(" \u96aa\u80b2\uff6e\u52b1\u2606\u7e67\ufffd ");
                        decTemp = decYoryo.multiply(decIrisu);
                        ret = decVal.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decTemp, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decIrisu,decZero)) || /* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                        ...
                        decTemp = decYoryo.multiply(decIrisu);
                        ret = decVal.multiply(decCoefficient).multiply(decSen).divide$com_java_BigDecimal$int$int(decTemp, scale, roundJoken);
                    }
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                    if (/* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decIrisu,decZero)) || /* equals */(<any>((o1: any, o2: any) => { if (o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(decYoryo,decZero))){
                        ret = decZero;
                        ...
                        decTemp = decYoryo.multiply(decIrisu);
                        ret = decVal.multiply(decCoefficient).multiply(decMan).divide$com_java_BigDecimal$int$int(decTemp, scale, roundJoken);
                    }
                } else {
                    com.fujitsu.sms.sol.sys.cjf.SMSCLLog.debug("\u879f\u753b\u92e4\u8815\u609f\u8170\u83f4\u962a\u2032\u8373\u80b4\uff6d\uff63:" + henkanGoTani);
                }
                ...
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    ret = decVal.multiply(decIrisu).multiply(decYoryo);
                    ret = ret.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decSen, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    ret = decVal.multiply(decYoryo);
                    ret = ret.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decSen, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decSen, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal;
                    ret = ret.multiply(decCoefficient).setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
                ...
                if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_CS){
                    ret = decVal.multiply(decIrisu).multiply(decYoryo);
                    ret = ret.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decMan, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KO){
                    ret = decVal.multiply(decYoryo);
                    ret = ret.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decMan, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_G){
                    ret = decVal.multiply(decCoefficient).divide$com_java_BigDecimal$int$int(decMan, scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_KG){
                    ret = decVal.multiply(decSen);
                    ret = ret.multiply(decCoefficient).setScale(scale, roundJoken);
                } else if (henkanGoTani === lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines.STR_HANBAI_TANI_T){
    ...
    YEMTSSF000LogicBase["__class"] = "lib.com.megsnow.yem.tss.cjf.YEMTSSF000LogicBase";
    YEMTSSF000LogicBase["__interfaces"] = ["lib.com.megsnow.yem.tss.cjf.YEMTSSF000Defines","lib.com.megsnow.yem.tss.cjf.YEMTSSF000ItemDefines"];
